...
When a documentation MCP server is available (DeepWiki or Context7), you have access to:
...
- **Gem documentation**: Understand how specific gems or libraries work
...
- Research unfamiliar gems or libraries used in the project
