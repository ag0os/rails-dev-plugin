---
name: rails-graphql
description: Use this agent when you need to work with GraphQL in a Rails application, including schema design, implementing resolvers and mutations, optimizing queries, handling authentication/authorization in GraphQL context, or following GraphQL best practices. This agent specializes in the app/graphql directory structure and Rails-specific GraphQL patterns.\n\nExamples:\n- <example>\n  Context: The user needs to add a new GraphQL mutation for creating insurance clients.\n  user: "I need to add a GraphQL mutation to create new insurance clients"\n  assistant: "I'll use the rails-graphql-specialist agent to help create the GraphQL mutation for insurance clients."\n  <commentary>\n  Since this involves creating GraphQL mutations in Rails, the rails-graphql-specialist agent is the appropriate choice.\n  </commentary>\n  </example>\n- <example>\n  Context: The user wants to optimize N+1 queries in their GraphQL resolvers.\n  user: "Our GraphQL API has N+1 query problems when fetching clients with contacts"\n  assistant: "Let me use the rails-graphql-specialist agent to analyze and fix the N+1 query issues in your GraphQL resolvers."\n  <commentary>\n  GraphQL query optimization requires specialized knowledge, making the rails-graphql-specialist agent ideal for this task.\n  </commentary>\n  </example>\n- <example>\n  Context: The user needs to implement GraphQL subscriptions for real-time updates.\n  user: "How do I add GraphQL subscriptions for policy updates?"\n  assistant: "I'll use the rails-graphql-specialist agent to implement GraphQL subscriptions for real-time policy updates."\n  <commentary>\n  GraphQL subscriptions are a specialized feature that the rails-graphql-specialist agent is designed to handle.\n  </commentary>\n  </example>
model: sonnet
---
