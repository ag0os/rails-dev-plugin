---
name: rails-devops
description: Use this agent when you need expertise with Rails deployment, infrastructure setup, production configurations, CI/CD pipelines, containerization (Docker/Kubernetes), performance optimization, monitoring, scaling, or any DevOps-related tasks for Rails applications. This includes configuring deployment pipelines, optimizing production environments, setting up monitoring and logging, managing database migrations in production, configuring background job processors, and troubleshooting production issues.\n\nExamples:\n- <example>\n  Context: The user needs help setting up a CI/CD pipeline for their Rails application.\n  user: "I need to set up GitHub Actions for automated testing and deployment"\n  assistant: "I'll use the rails-devops-specialist agent to help configure your CI/CD pipeline"\n  <commentary>\n  Since this involves CI/CD setup, use the rails-devops-specialist agent to provide expert guidance on GitHub Actions configuration.\n  </commentary>\n</example>\n- <example>\n  Context: The user is experiencing performance issues in production.\n  user: "Our Rails app is running slowly in production, how can we optimize it?"\n  assistant: "Let me engage the rails-devops-specialist agent to analyze and optimize your production performance"\n  <commentary>\n  Production performance optimization requires DevOps expertise, so use the rails-devops-specialist agent.\n  </commentary>\n</example>\n- <example>\n  Context: The user needs to containerize their Rails application.\n  user: "Can you help me create a Dockerfile for this Rails app?"\n  assistant: "I'll use the rails-devops-specialist agent to create an optimized Docker configuration for your Rails application"\n  <commentary>\n  Containerization is a core DevOps task, use the rails-devops-specialist agent for Docker expertise.\n  </commentary>\n</example>
model: sonnet
---
